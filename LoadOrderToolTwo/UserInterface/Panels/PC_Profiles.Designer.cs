...
partial class PC_Profiles
{
	...
	private void InitializeComponent()
	{
			...
			this.TLP_LaunchSettings = new SlickControls.RoundedTableLayoutPanel();
			this.slickIcon2 = new SlickControls.SlickIcon();
			this.L_LaunchSettings = new System.Windows.Forms.Label();
			...
			this.TLP_ProfileName.Controls.Add(this.slickIcon1, 0, 0);
			this.TLP_ProfileName.Controls.Add(this.L_CurrentProfile, 1, 0);
			this.TLP_ProfileName.Controls.Add(this.B_Edit, 2, 0);
			...
			this.B_Edit.Location = new System.Drawing.Point(107, 8);
			...
			this.TLP_Options.Controls.Add(this.CB_AutoSave, 0, 0);
			this.TLP_Options.Controls.Add(this.TLP_LaunchSettings, 0, 1);
			...
			this.TLP_Options.Padding = new System.Windows.Forms.Padding(10);
			this.TLP_Options.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.TLP_Options.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.TLP_Options.Size = new System.Drawing.Size(441, 313);
			...
			this.CB_AutoSave.Location = new System.Drawing.Point(13, 13);
			this.CB_AutoSave.Margin = new System.Windows.Forms.Padding(3, 3, 3, 10);
			...
			this.TLP_LaunchSettings.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
			this.TLP_LaunchSettings.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
			this.TLP_LaunchSettings.Controls.Add(this.slickIcon2, 0, 0);
			this.TLP_LaunchSettings.Controls.Add(this.L_LaunchSettings, 1, 0);
			this.TLP_LaunchSettings.Controls.Add(this.CB_NoMods, 3, 2);
			this.TLP_LaunchSettings.Controls.Add(this.CB_LoadSave, 0, 3);
			this.TLP_LaunchSettings.Controls.Add(this.CB_LHT, 0, 1);
			this.TLP_LaunchSettings.Controls.Add(this.TB_SavePath, 0, 4);
			this.TLP_LaunchSettings.Controls.Add(this.CB_NoWorkshop, 0, 2);
			this.TLP_LaunchSettings.Controls.Add(this.CB_NoAssets, 2, 2);
			this.TLP_LaunchSettings.Location = new System.Drawing.Point(13, 60);
			this.TLP_LaunchSettings.Name = "TLP_LaunchSettings";
			this.TLP_LaunchSettings.Padding = new System.Windows.Forms.Padding(10);
			this.TLP_LaunchSettings.RowCount = 4;
			...
			this.TLP_LaunchSettings.Size = new System.Drawing.Size(415, 240);
			this.TLP_LaunchSettings.TabIndex = 1;
			// 
			// slickIcon2
			// 
			this.slickIcon2.ActiveColor = null;
			this.slickIcon2.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this.slickIcon2.Cursor = System.Windows.Forms.Cursors.Hand;
			this.slickIcon2.Enabled = false;
			this.slickIcon2.Image = global::LoadOrderToolTwo.Properties.Resources.I_Launch;
			this.slickIcon2.Location = new System.Drawing.Point(13, 13);
			this.slickIcon2.Name = "slickIcon2";
			this.slickIcon2.Size = new System.Drawing.Size(32, 32);
			this.slickIcon2.TabIndex = 2;
			this.slickIcon2.TabStop = false;
			// 
			// L_LaunchSettings
			// 
			this.L_LaunchSettings.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this.L_LaunchSettings.AutoSize = true;
			this.TLP_LaunchSettings.SetColumnSpan(this.L_LaunchSettings, 3);
			this.L_LaunchSettings.Location = new System.Drawing.Point(51, 17);
			this.L_LaunchSettings.Name = "L_LaunchSettings";
			this.L_LaunchSettings.Size = new System.Drawing.Size(55, 23);
			this.L_LaunchSettings.TabIndex = 0;
			this.L_LaunchSettings.Text = "label1";
			// 
			// CB_NoMods
			// 
			...
			this.CB_NoMods.Location = new System.Drawing.Point(290, 105);
			...
			this.CB_LoadSave.Location = new System.Drawing.Point(13, 152);
			...
			this.CB_LHT.Location = new System.Drawing.Point(13, 58);
			...
			this.TB_SavePath.Location = new System.Drawing.Point(13, 192);
			...
			this.TB_SavePath.Size = new System.Drawing.Size(389, 35);
			...
			this.CB_NoWorkshop.Location = new System.Drawing.Point(13, 105);
			...
			this.CB_NoAssets.Location = new System.Drawing.Point(167, 105);
	...
	private SlickControls.RoundedTableLayoutPanel TLP_LaunchSettings;
	private SlickControls.SlickIcon slickIcon2;
	private System.Windows.Forms.Label L_LaunchSettings;
