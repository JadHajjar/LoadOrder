...
internal class ItemListControl<T> : SlickStackedListControl<T> where T : IPackage
{
    ...
    private Rectangles GetActionRectangles(Rectangle rectangle, T item)
    {
        ...
        if (item.Workshop)
        {
            ...
            rects.AuthorRect = new Rectangle(rects.RedownloadRect.X - (int)(100 * UI.FontScale), rectangle.Y, (int)(100 * UI.FontScale), rectangle.Height / 2);
